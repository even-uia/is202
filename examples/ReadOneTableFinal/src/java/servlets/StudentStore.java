...
public class StudentStore extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet StudentStore</title>");            
            out.println("</head>");
            out.println("<body>");
            // out.println("<h1>Servlet StudentStore at " + request.getContextPath() + "</h1>");
            ...
            studentTools.studentStore(snr,firstName,lastName,out);
